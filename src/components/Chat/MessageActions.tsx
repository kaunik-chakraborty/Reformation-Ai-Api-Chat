...
const MessageActions: React.FC<MessageActionsProps> = ({ onRegenerate, content, isUser }) => {
  ...
  return (
    <div className="mt-3 p-1 bg-[var(--card)] rounded-[var(--global-radius)] shadow-sm hover:shadow transition-shadow duration-200">
      ...
      <div className="flex flex-col gap-2 md:hidden">
        <div className="flex justify-between gap-2">
          ...
          >
            <svg
              ...
              className="w-5 h-5 text-[var(--text)] group-hover:text-[var(--accent)] transition-colors duration-200"
            >
              <path
            ...
            <span className="text-sm font-medium text-[var(--text)] group-hover:text-[var(--accent)] transition-colors duration-200">Rewrite</span>
          </button>
          ...
          >
            ...
            <span className="text-sm font-medium text-[var(--text)] group-hover:text-[var(--accent)] transition-colors duration-200">Copy</span>
            {showCopied && (
        ...
        <div className="flex justify-between gap-2">
          ...
          >
            <IoShareOutline className="w-5 h-5 text-[var(--text)] group-hover:text-[var(--accent)] transition-colors duration-200" />
            <span className="text-sm font-medium text-[var(--text)] group-hover:text-[var(--accent)] transition-colors duration-200">Share</span>
          </button>
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              <IoDownloadOutline className="w-5 h-5 text-[var(--text)] group-hover:text-[var(--accent)] transition-colors duration-200" />
              <span className="text-sm font-medium text-[var(--text)] group-hover:text-[var(--accent)] transition-colors duration-200">Export</span>
            </button>
